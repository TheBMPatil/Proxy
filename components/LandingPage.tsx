    ...
    <div className="h-full bg-dark-900 text-white flex flex-col p-6 relative overflow-hidden overflow-y-auto">
      ...
      <div className="flex-1 flex flex-col justify-center items-center text-center mt-4">
        ...
        <h1 className="text-4xl md:text-5xl font-black mb-4 leading-tight tracking-tight">
          {t('title').split(' ').slice(0, 2).join(' ')} <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-blue to-neon-purple">{t('title').split(' ').slice(2).join(' ')}</span>.
        </h1>
      ...
      <div className="mt-8 space-y-4 mb-6">
        <h3 className="text-gray-500 font-bold uppercase tracking-widest text-xs mb-2">{t('whyNeed')}</h3>
        
        <div className="bg-dark-800 p-4 rounded-xl border border-gray-800 flex items-start gap-3">
          <span className="text-2xl">🛑</span>
          <div>
            <h4 className="font-bold text-white">{t('attentionSpan')}</h4>
            <p className="text-sm text-gray-400">{t('attentionDesc')}</p>
          </div>
        </div>
        ...
        <div className="bg-dark-800 p-4 rounded-xl border border-gray-800 flex items-start gap-3">
          <span className="text-2xl">🤯</span>
          <div>
            <h4 className="font-bold text-white">{t('inLaws')}</h4>
            <p className="text-sm text-gray-400">{t('inLawsDesc')}</p>
          </div>
        </div>
        ...
        <div className="bg-dark-800 p-4 rounded-xl border border-gray-800 flex items-start gap-3">
          <span className="text-2xl">😭</span>
          <div>
            <h4 className="font-bold text-white">{t('crying')}</h4>
            <p className="text-sm text-gray-400">{t('cryingDesc')}</p>
          </div>
        </div>
      </div>
